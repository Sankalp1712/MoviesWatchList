...
//   return (
//     <div className=' loginDiv bg-dark text-white'>
...
const Login: React.FC = () => {
  ...
  return (
    <div className='loginDiv bg-dark text-white'>
      <div className='container-fluid d-flex flex-column align-items-center justify-content-center h-100 text-center'>
        <h1>Welcome to CineTrack</h1>
        <div className='d-flex mt-3 p-2 w-100 justify-content-center'>
          <button onClick={() => handleClick('user')} className='btn btn-primary m-2' value='user'>
            Login as User
          </button>
          <button onClick={() => handleClick('admin')} className='btn btn-secondary m-2' value='admin'>
            Login as Admin
          </button>
        </div>
      </div>
